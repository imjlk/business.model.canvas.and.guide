...
/** Arguments for filtering the BMCTagToBMCanvasConnection connection */
export interface BMCTagToBMCanvasConnectionWhereArgs {
...
/** Arguments for filtering the BMCTagToContentNodeConnection connection */
export interface BMCTagToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfBMCTagEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
/** Arguments for filtering the BMCTagToOpenCanvasConnection connection */
export interface BMCTagToOpenCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Set relationships between the bMCanvas to bMCTags */
export interface BMCanvasBMCTagsInput {
  /** If true, this will append the bMCTag to existing related bMCTags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<BMCanvasBMCTagsNodeInput>>>;
}

/** List of bMCTags to connect the bMCanvas to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface BMCanvasBMCTagsNodeInput {
  /** The description of the bMCTag. This field is used to set a description of the bMCTag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the bMCTag. If present, this will be used to connect to the bMCanvas. If no existing bMCTag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the bMCTag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the bMCTag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars["String"]>;
}

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum BMCanvasIdType {
...
/** Arguments for filtering the BMCanvasToBMCTagConnection connection */
export interface BMCanvasToBMCTagConnectionWhereArgs {
...
/** Arguments for filtering the BMCanvasToTermNodeConnection connection */
export interface BMCanvasToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Allowed Content Types of the BMCTag taxonomy. */
export enum ContentTypesOfBMCTagEnum {
  /** The Type of Content object */
  BMCANVAS = "BMCANVAS",
  /** The Type of Content object */
  OPENCANVAS = "OPENCANVAS",
...
/** Allowed Content Types of the Featured taxonomy. */
export enum ContentTypesOfFeaturedEnum {
  /** The Type of Content object */
  OPENCANVAS = "OPENCANVAS",
}
...
/** Input for the createBMCTag mutation */
export interface CreateBMCTagInput {
  /** The slug that the bmctag will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the bmctag object */
  description?: InputMaybe<Scalars["String"]>;
  /** The name of the bmctag object to mutate */
  name: Scalars["String"];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars["String"]>;
}

/** Input for the createBMCanvas mutation */
export interface CreateBMCanvasInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** Set connections between the bMCanvas and bMCTags */
  bMCTags?: InputMaybe<BMCanvasBMCTagsInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
/** Input for the createFeatured mutation */
export interface CreateFeaturedInput {
  /** The slug that the featured will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the featured object */
  description?: InputMaybe<Scalars["String"]>;
  /** The name of the featured object to mutate */
  name: Scalars["String"];
  /** The ID of the featured that should be set as the parent */
  parentId?: InputMaybe<Scalars["ID"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars["String"]>;
}
...
/** Input for the createOpenCanvas mutation */
export interface CreateOpenCanvasInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** Set connections between the openCanvas and bMCTags */
  bMCTags?: InputMaybe<OpenCanvasBMCTagsInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** Set connections between the openCanvas and featuredList */
  featuredList?: InputMaybe<OpenCanvasFeaturedListInput>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
  password?: InputMaybe<Scalars["String"]>;
...
/** Input for the deleteBMCTag mutation */
export interface DeleteBMCTagInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The ID of the bMCTag to delete */
  id: Scalars["ID"];
}

/** Input for the deleteBMCanvas mutation */
export interface DeleteBMCanvasInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the bMCanvas to delete */
  id: Scalars["ID"];
}
...
/** Input for the deleteFeatured mutation */
export interface DeleteFeaturedInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The ID of the featured to delete */
  id: Scalars["ID"];
}
...
/** Input for the deleteOpenCanvas mutation */
export interface DeleteOpenCanvasInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the openCanvas to delete */
  id: Scalars["ID"];
}
...
/** Arguments for filtering the FeaturedToContentNodeConnection connection */
export interface FeaturedToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfFeaturedEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
/** Arguments for filtering the FeaturedToFeaturedConnection connection */
export interface FeaturedToFeaturedConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the FeaturedToOpenCanvasConnection connection */
export interface FeaturedToOpenCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Set relationships between the openCanvas to bMCTags */
export interface OpenCanvasBMCTagsInput {
  /** If true, this will append the bMCTag to existing related bMCTags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<OpenCanvasBMCTagsNodeInput>>>;
}

/** List of bMCTags to connect the openCanvas to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface OpenCanvasBMCTagsNodeInput {
  /** The description of the bMCTag. This field is used to set a description of the bMCTag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the bMCTag. If present, this will be used to connect to the openCanvas. If no existing bMCTag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the bMCTag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the bMCTag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Set relationships between the openCanvas to featuredList */
export interface OpenCanvasFeaturedListInput {
  /** If true, this will append the featured to existing related featuredList. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<OpenCanvasFeaturedListNodeInput>>>;
}

/** List of featuredList to connect the openCanvas to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface OpenCanvasFeaturedListNodeInput {
  /** The description of the featured. This field is used to set a description of the featured if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the featured. If present, this will be used to connect to the openCanvas. If no existing featured exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the featured. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the featured. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars["String"]>;
}

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum OpenCanvasIdType {
  /** Identify a resource by the Database ID. */
  DATABASE_ID = "DATABASE_ID",
  /** Identify a resource by the (hashed) Global ID. */
  ID = "ID",
...
/** Arguments for filtering the OpenCanvasToBMCTagConnection connection */
export interface OpenCanvasToBMCTagConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the OpenCanvasToFeaturedConnection connection */
export interface OpenCanvasToFeaturedConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the OpenCanvasToTermNodeConnection connection */
export interface OpenCanvasToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the RootQueryToBMCTagConnection connection */
export interface RootQueryToBMCTagConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the RootQueryToBMCanvasConnection connection */
export interface RootQueryToBMCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the RootQueryToFeaturedConnection connection */
export interface RootQueryToFeaturedConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the RootQueryToOpenCanvasConnection connection */
export interface RootQueryToOpenCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export enum TaxonomyEnum {
  /** Taxonomy enum bmctag */
  BMCTAG = "BMCTAG",
  /** Taxonomy enum category */
  CATEGORY = "CATEGORY",
  /** Taxonomy enum featured */
  FEATURED = "FEATURED",
...
/** Input for the UpdateBMCTag mutation */
export interface UpdateBMCTagInput {
  /** The slug that the bmctag will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the bmctag object */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the bMCTag object to update */
  id: Scalars["ID"];
  /** The name of the bmctag object to mutate */
  name?: InputMaybe<Scalars["String"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** Input for the updateBMCanvas mutation */
export interface UpdateBMCanvasInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** Set connections between the bMCanvas and bMCTags */
  bMCTags?: InputMaybe<BMCanvasBMCTagsInput>;
...
/** Input for the UpdateFeatured mutation */
export interface UpdateFeaturedInput {
  ...
  /** The description of the featured object */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the featured object to update */
  id: Scalars["ID"];
  /** The name of the featured object to mutate */
  name?: InputMaybe<Scalars["String"]>;
  /** The ID of the featured that should be set as the parent */
...
/** Input for the updateOpenCanvas mutation */
export interface UpdateOpenCanvasInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** Set connections between the openCanvas and bMCTags */
  bMCTags?: InputMaybe<OpenCanvasBMCTagsInput>;
  ...
  /** Set connections between the openCanvas and featuredList */
  featuredList?: InputMaybe<OpenCanvasFeaturedListInput>;
  /** The ID of the openCanvas object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
...
/** Arguments for filtering the UserToBMCanvasConnection connection */
export interface UserToBMCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the UserToOpenCanvasConnection connection */
export interface UserToOpenCanvasConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const scalarsEnumsHash: import("gqty").ScalarsEnumsHash = {
  ...
  ContentTypesOfBMCTagEnum: true,
  ContentTypesOfCategoryEnum: true,
  ContentTypesOfFeaturedEnum: true,
...
export const generatedSchema = {
  ...
  BMCTag: {
    ...
    bMCTagId: { __type: "Int" },
    bMCanvases: {
      __type: "BMCTagToBMCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BMCTagToBMCanvasConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "BMCTagToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BMCTagToContentNodeConnectionWhereArgs",
      },
    },
    count: { __type: "Int" },
    ...
    name: { __type: "String" },
    openCanvases: {
      __type: "BMCTagToOpenCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BMCTagToOpenCanvasConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    taxonomy: { __type: "BMCTagToTaxonomyConnectionEdge" },
  ...
  BMCTagToBMCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BMCTagToBMCanvasConnectionEdge]" },
    nodes: { __type: "[BMCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BMCTagToBMCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCanvas" },
  },
  BMCTagToBMCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
  ...
  BMCTagToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BMCTagToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BMCTagToContentNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ContentNode" },
  },
  BMCTagToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfBMCTagEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  BMCTagToOpenCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BMCTagToOpenCanvasConnectionEdge]" },
    nodes: { __type: "[OpenCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BMCTagToOpenCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "OpenCanvas" },
  },
  BMCTagToOpenCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  BMCTagToTaxonomyConnectionEdge: {
    __typename: { __type: "String!" },
  ...
  BMCanvas: {
    ...
    authorId: { __type: "ID" },
    bMCTags: {
      __type: "BMCanvasToBMCTagConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BMCanvasToBMCTagConnectionWhereArgs",
      },
    },
    bMCanvasId: { __type: "Int!" },
    conditionalTags: { __type: "ConditionalTags" },
    ...
    preview: { __type: "BMCanvasToPreviewConnectionEdge" },
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "BMCanvasToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BMCanvasToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  BMCanvasBMCTagsInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[BMCanvasBMCTagsNodeInput]" },
  },
  BMCanvasBMCTagsNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  },
  BMCanvasToBMCTagConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BMCanvasToBMCTagConnectionEdge]" },
    nodes: { __type: "[BMCTag]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BMCanvasToBMCTagConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCTag" },
  },
  BMCanvasToBMCTagConnectionWhereArgs: {
  ...
  BMCanvasToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "BMCanvas" },
  },
  BMCanvasToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BMCanvasToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BMCanvasToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  BMCanvasToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  CreateBMCTagPayload: {
    __typename: { __type: "String!" },
    bMCTag: { __type: "BMCTag" },
    clientMutationId: { __type: "String" },
  },
  CreateBMCanvasInput: {
    authorId: { __type: "ID" },
    bMCTags: { __type: "BMCanvasBMCTagsInput" },
    clientMutationId: { __type: "String" },
    date: { __type: "String" },
  ...
  CreateBMCanvasPayload: {
    __typename: { __type: "String!" },
    bMCanvas: { __type: "BMCanvas" },
    clientMutationId: { __type: "String" },
  },
  CreateCategoryInput: {
    aliasOf: { __type: "String" },
  ...
  CreateOpenCanvasInput: {
    authorId: { __type: "ID" },
    bMCTags: { __type: "OpenCanvasBMCTagsInput" },
    clientMutationId: { __type: "String" },
    date: { __type: "String" },
    featuredList: { __type: "OpenCanvasFeaturedListInput" },
    menuOrder: { __type: "Int" },
    password: { __type: "String" },
    slug: { __type: "String" },
    status: { __type: "PostStatusEnum" },
  ...
  CreateOpenCanvasPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    openCanvas: { __type: "OpenCanvas" },
  },
  CreatePageInput: {
    authorId: { __type: "ID" },
    clientMutationId: { __type: "String" },
  ...
  DeleteOpenCanvasInput: {
    clientMutationId: { __type: "String" },
    forceDelete: { __type: "Boolean" },
    id: { __type: "ID!" },
  },
  DeleteOpenCanvasPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
    openCanvas: { __type: "OpenCanvas" },
  ...
  Featured: {
    __typename: { __type: "String!" },
    ancestors: {
      __type: "FeaturedToAncestorsFeaturedConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    children: {
      __type: "FeaturedToFeaturedConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "FeaturedToFeaturedConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "FeaturedToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "FeaturedToContentNodeConnectionWhereArgs",
      },
    },
    count: { __type: "Int" },
    databaseId: { __type: "Int!" },
    ...
    name: { __type: "String" },
    openCanvases: {
      __type: "FeaturedToOpenCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "FeaturedToOpenCanvasConnectionWhereArgs",
      },
    },
    parent: { __type: "FeaturedToParentFeaturedConnectionEdge" },
    parentDatabaseId: { __type: "Int" },
    parentId: { __type: "ID" },
    slug: { __type: "String" },
    taxonomy: { __type: "FeaturedToTaxonomyConnectionEdge" },
    taxonomyName: { __type: "String" },
    templates: { __type: "[String]" },
    termGroupId: { __type: "Int" },
    termTaxonomyId: { __type: "Int" },
  ...
  FeaturedToAncestorsFeaturedConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[FeaturedToAncestorsFeaturedConnectionEdge]" },
    nodes: { __type: "[Featured]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  FeaturedToAncestorsFeaturedConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Featured" },
  },
  FeaturedToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[FeaturedToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  FeaturedToContentNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ContentNode" },
  },
  FeaturedToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfFeaturedEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  FeaturedToFeaturedConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[FeaturedToFeaturedConnectionEdge]" },
    nodes: { __type: "[Featured]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  FeaturedToFeaturedConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Featured" },
  },
  FeaturedToFeaturedConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  FeaturedToOpenCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[FeaturedToOpenCanvasConnectionEdge]" },
    nodes: { __type: "[OpenCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  FeaturedToOpenCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "OpenCanvas" },
  },
  FeaturedToOpenCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  FeaturedToParentFeaturedConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Featured" },
  },
  FeaturedToTaxonomyConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Taxonomy" },
  },
  GeneralSettings: {
  ...
  OpenCanvas: {
    ...
    authorId: { __type: "ID" },
    bMCTags: {
      __type: "OpenCanvasToBMCTagConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "OpenCanvasToBMCTagConnectionWhereArgs",
      },
    },
    channels: { __type: "[String]" },
    conditionalTags: { __type: "ConditionalTags" },
    contentType: { __type: "ContentNodeToContentTypeConnectionEdge" },
    contentTypeName: { __type: "String!" },
    costStructure: { __type: "[String]" },
    customerRelationships: { __type: "[String]" },
    customerSegments: { __type: "[String]" },
    databaseId: { __type: "Int!" },
    date: { __type: "String" },
    dateGmt: { __type: "String" },
    desiredSlug: { __type: "String" },
    ...
    featuredList: {
      __type: "OpenCanvasToFeaturedConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "OpenCanvasToFeaturedConnectionWhereArgs",
      },
    },
    guid: { __type: "String" },
    id: { __type: "ID!" },
    ...
    isRestricted: { __type: "Boolean" },
    isTermNode: { __type: "Boolean!" },
    keyActivities: { __type: "[String]" },
    keyPartners: { __type: "[String]" },
    keyResources: { __type: "[String]" },
    lastEditedBy: { __type: "ContentNodeToEditLastConnectionEdge" },
    link: { __type: "String" },
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    openCanvasId: { __type: "Int!" },
    preview: { __type: "OpenCanvasToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    revenueStreams: { __type: "[String]" },
    slug: { __type: "String" },
    status: { __type: "String" },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    terms: {
      __type: "OpenCanvasToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "OpenCanvasToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
    ...
    uri: { __type: "String" },
    valuePropositions: { __type: "[String]" },
  },
  OpenCanvasBMCTagsInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[OpenCanvasBMCTagsNodeInput]" },
  },
  OpenCanvasBMCTagsNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  },
  OpenCanvasFeaturedListInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[OpenCanvasFeaturedListNodeInput]" },
  },
  OpenCanvasFeaturedListNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  },
  OpenCanvasToBMCTagConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[OpenCanvasToBMCTagConnectionEdge]" },
    nodes: { __type: "[BMCTag]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  OpenCanvasToBMCTagConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCTag" },
  },
  OpenCanvasToBMCTagConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  OpenCanvasToFeaturedConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[OpenCanvasToFeaturedConnectionEdge]" },
    nodes: { __type: "[Featured]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  OpenCanvasToFeaturedConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Featured" },
  },
  OpenCanvasToFeaturedConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  OpenCanvasToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "OpenCanvas" },
  },
  OpenCanvasToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[OpenCanvasToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  OpenCanvasToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  OpenCanvasToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToBMCTagConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToBMCTagConnectionEdge]" },
    nodes: { __type: "[BMCTag]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToBMCTagConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCTag" },
  },
  RootQueryToBMCTagConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToBMCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToBMCanvasConnectionEdge]" },
    nodes: { __type: "[BMCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToBMCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCanvas" },
  },
  RootQueryToBMCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToFeaturedConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToFeaturedConnectionEdge]" },
    nodes: { __type: "[Featured]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToFeaturedConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Featured" },
  },
  RootQueryToFeaturedConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToOpenCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToOpenCanvasConnectionEdge]" },
    nodes: { __type: "[OpenCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToOpenCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "OpenCanvas" },
  },
  RootQueryToOpenCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  User: {
    ...
    bMCanvases: {
      __type: "UserToBMCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToBMCanvasConnectionWhereArgs",
      },
    },
    ...
    nickname: { __type: "String" },
    openCanvases: {
      __type: "UserToOpenCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToOpenCanvasConnectionWhereArgs",
      },
    },
    pages: {
  ...
  UserToBMCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToBMCanvasConnectionEdge]" },
    nodes: { __type: "[BMCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToBMCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BMCanvas" },
  },
  UserToBMCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToOpenCanvasConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToOpenCanvasConnectionEdge]" },
    nodes: { __type: "[OpenCanvas]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToOpenCanvasConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "OpenCanvas" },
  },
  UserToOpenCanvasConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    __typename: { __type: "String!" },
    createBMCTag: {
      __type: "CreateBMCTagPayload",
      __args: { input: "CreateBMCTagInput!" },
    },
    createBMCanvas: {
      __type: "CreateBMCanvasPayload",
      __args: { input: "CreateBMCanvasInput!" },
    },
    createCategory: {
    ...
    createFeatured: {
      __type: "CreateFeaturedPayload",
      __args: { input: "CreateFeaturedInput!" },
    },
    createMediaItem: {
    ...
    createOpenCanvas: {
      __type: "CreateOpenCanvasPayload",
      __args: { input: "CreateOpenCanvasInput!" },
    },
    createPage: {
    ...
    deleteBMCTag: {
      __type: "DeleteBMCTagPayload",
      __args: { input: "DeleteBMCTagInput!" },
    },
    deleteBMCanvas: {
      __type: "DeleteBMCanvasPayload",
      __args: { input: "DeleteBMCanvasInput!" },
    },
    deleteCategory: {
    ...
    deleteFeatured: {
      __type: "DeleteFeaturedPayload",
      __args: { input: "DeleteFeaturedInput!" },
    },
    deleteMediaItem: {
    ...
    deleteOpenCanvas: {
      __type: "DeleteOpenCanvasPayload",
      __args: { input: "DeleteOpenCanvasInput!" },
    },
    deletePage: {
    ...
    updateBMCTag: {
      __type: "UpdateBMCTagPayload",
      __args: { input: "UpdateBMCTagInput!" },
    },
    updateBMCanvas: {
      __type: "UpdateBMCanvasPayload",
      __args: { input: "UpdateBMCanvasInput!" },
    },
    updateCategory: {
    ...
    updateFeatured: {
      __type: "UpdateFeaturedPayload",
      __args: { input: "UpdateFeaturedInput!" },
    },
    updateMediaItem: {
    ...
    updateOpenCanvas: {
      __type: "UpdateOpenCanvasPayload",
      __args: { input: "UpdateOpenCanvasInput!" },
    },
    updatePage: {
  ...
  query: {
    ...
    bMCTag: { __type: "BMCTag", __args: { id: "ID!", idType: "BMCTagIdType" } },
    bMCTags: {
      __type: "RootQueryToBMCTagConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToBMCTagConnectionWhereArgs",
      },
    },
    bMCanvas: {
      __type: "BMCanvas",
      __args: { asPreview: "Boolean", id: "ID!", idType: "BMCanvasIdType" },
    },
    bMCanvasBy: {
      __type: "BMCanvas",
      __args: { bMCanvasId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    bMCanvases: {
      __type: "RootQueryToBMCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToBMCanvasConnectionWhereArgs",
      },
    },
    categories: {
    ...
    featured: {
      __type: "Featured",
      __args: { id: "ID!", idType: "FeaturedIdType" },
    },
    featuredList: {
      __type: "RootQueryToFeaturedConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToFeaturedConnectionWhereArgs",
      },
    },
    generalSettings: { __type: "GeneralSettings" },
    mediaItem: {
    ...
    openCanvas: {
      __type: "OpenCanvas",
      __args: { asPreview: "Boolean", id: "ID!", idType: "OpenCanvasIdType" },
    },
    openCanvasBy: {
      __type: "OpenCanvas",
      __args: { id: "ID", openCanvasId: "Int", slug: "String", uri: "String" },
    },
    openCanvases: {
      __type: "RootQueryToOpenCanvasConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToOpenCanvasConnectionWhereArgs",
      },
    },
    page: {
      __type: "Page",
  ...
  [SchemaUnionsKey]: {
    ...
    MenuItemLinkable: ["BMCTag", "Category", "Featured", "Page", "Post", "Tag"],
    Node: [
      "BMCTag",
      "BMCanvas",
      "Category",
    ...
    TermNode: ["BMCTag", "Category", "Featured", "PostFormat", "Tag"],
    UniformResourceIdentifiable: [
      "BMCTag",
      "BMCanvas",
      "Category",
    ...
    ContentNode: ["BMCanvas", "MediaItem", "OpenCanvas", "Page", "Post"],
    NodeWithAuthor: ["BMCanvas", "MediaItem", "OpenCanvas", "Page", "Post"],
    NodeWithTemplate: ["BMCanvas", "MediaItem", "OpenCanvas", "Page", "Post"],
    NodeWithTitle: ["BMCanvas", "MediaItem", "OpenCanvas", "Page", "Post"],
    HierarchicalTermNode: ["Category", "Featured"],
 ...
 * The bMCTag type
 */
export interface BMCTag {
  __typename?: "BMCTag";
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  bMCTagId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * Connection between the bMCTag type and the bMCanvas type
   */
  bMCanvases: (args?: {
    /**
     ...
     */
    where?: Maybe<BMCTagToBMCanvasConnectionWhereArgs>;
  }) => Maybe<BMCTagToBMCanvasConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the bMCTag type and the ContentNode type
   */
  contentNodes: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BMCTagToContentNodeConnectionWhereArgs>;
  }) => Maybe<BMCTagToContentNodeConnection>;
  /**
  ...
  /**
   * Connection between the bMCTag type and the openCanvas type
   */
  openCanvases: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BMCTagToOpenCanvasConnectionWhereArgs>;
  }) => Maybe<BMCTagToOpenCanvasConnection>;
  /**
   * An alphanumeric identifier for the object unique to its type.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the bMCTag type and the Taxonomy type
   */
  taxonomy?: Maybe<BMCTagToTaxonomyConnectionEdge>;
  /**
 ...
 * Connection between the bMCTag type and the bMCanvas type
 */
export interface BMCTagToBMCanvasConnection {
  __typename?: "BMCTagToBMCanvasConnection";
  /**
   * Edges for the BMCTagToBMCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<BMCTagToBMCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCanvas>>>;
  /**
 ...
 */
export interface BMCTagToBMCanvasConnectionEdge {
  __typename?: "BMCTagToBMCanvasConnectionEdge";
  /**
 ...
 * Connection between the bMCTag type and the ContentNode type
 */
export interface BMCTagToContentNodeConnection {
  __typename?: "BMCTagToContentNodeConnection";
  /**
   * Edges for the BMCTagToContentNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<BMCTagToContentNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BMCTagToContentNodeConnectionEdge {
  __typename?: "BMCTagToContentNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the bMCTag type and the openCanvas type
 */
export interface BMCTagToOpenCanvasConnection {
  __typename?: "BMCTagToOpenCanvasConnection";
  /**
   * Edges for the BMCTagToOpenCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<BMCTagToOpenCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<OpenCanvas>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface BMCTagToOpenCanvasConnectionEdge {
  __typename?: "BMCTagToOpenCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
   ...
   * The item at the end of the edge
   */
  node?: Maybe<OpenCanvas>;
}

/**
 * Connection between the bMCTag type and the Taxonomy type
 */
export interface BMCTagToTaxonomyConnectionEdge {
  __typename?: "BMCTagToTaxonomyConnectionEdge";
  /**
...
export interface BMCanvas {
  ...
  /**
   * Connection between the bMCanvas type and the bMCTag type
   */
  bMCTags: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BMCanvasToBMCTagConnectionWhereArgs>;
  }) => Maybe<BMCanvasToBMCTagConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  bMCanvasId: ScalarsEnums["Int"];
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  ...
  /**
   * The globally unique identifier of the bmcanvas object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
   ...
   * Can see anyone
   */
  isPublic?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * Whether the object is restricted from the current viewer
   */
  isRestricted?: Maybe<ScalarsEnums["Boolean"]>;
  ...
  /**
   * Connection between the bMCanvas type and the bMCanvas type
   */
  preview?: Maybe<BMCanvasToPreviewConnectionEdge>;
  /**
  ...
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * Connection between the bMCanvas type and the TermNode type
   */
  terms: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BMCanvasToTermNodeConnectionWhereArgs>;
  }) => Maybe<BMCanvasToTermNodeConnection>;
  /**
 ...
 * Connection between the bMCanvas type and the bMCTag type
 */
export interface BMCanvasToBMCTagConnection {
  __typename?: "BMCanvasToBMCTagConnection";
  /**
   * Edges for the BMCanvasToBMCTagConnection connection
   */
  edges?: Maybe<Array<Maybe<BMCanvasToBMCTagConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCTag>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface BMCanvasToBMCTagConnectionEdge {
  __typename?: "BMCanvasToBMCTagConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the bMCanvas type and the bMCanvas type
 */
export interface BMCanvasToPreviewConnectionEdge {
  __typename?: "BMCanvasToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<BMCanvas>;
 ...
 * Connection between the bMCanvas type and the TermNode type
 */
export interface BMCanvasToTermNodeConnection {
  __typename?: "BMCanvasToTermNodeConnection";
  /**
   * Edges for the BMCanvasToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<BMCanvasToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BMCanvasToTermNodeConnectionEdge {
  __typename?: "BMCanvasToTermNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface ContentNode {
  __typename?: "BMCanvas" | "MediaItem" | "OpenCanvas" | "Page" | "Post";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
/**
 * The payload for the createBMCTag mutation
 */
export interface CreateBMCTagPayload {
  __typename?: "CreateBMCTagPayload";
  /**
   * The created bmctag
   */
  bMCTag?: Maybe<BMCTag>;
...
/**
 * The payload for the createBMCanvas mutation
 */
export interface CreateBMCanvasPayload {
  __typename?: "CreateBMCanvasPayload";
  /**
   * The Post object mutation type.
   */
  bMCanvas?: Maybe<BMCanvas>;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the createFeatured mutation
 */
...
/**
 * The payload for the createOpenCanvas mutation
 */
export interface CreateOpenCanvasPayload {
  __typename?: "CreateOpenCanvasPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteBMCTag mutation
 */
export interface DeleteBMCTagPayload {
  __typename?: "DeleteBMCTagPayload";
  /**
...
/**
 * The payload for the deleteBMCanvas mutation
 */
export interface DeleteBMCanvasPayload {
  __typename?: "DeleteBMCanvasPayload";
  /**
...
/**
 * The payload for the deleteFeatured mutation
 */
export interface DeleteFeaturedPayload {
...
/**
 * The payload for the deleteOpenCanvas mutation
 */
export interface DeleteOpenCanvasPayload {
  __typename?: "DeleteOpenCanvasPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Featured {
  ...
  ancestors: (args?: {
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<FeaturedToAncestorsFeaturedConnection>;
  /**
   * Connection between the featured type and the featured type
   */
  children: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<FeaturedToFeaturedConnectionWhereArgs>;
  }) => Maybe<FeaturedToFeaturedConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the featured type and the ContentNode type
   */
  contentNodes: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<FeaturedToContentNodeConnectionWhereArgs>;
  }) => Maybe<FeaturedToContentNodeConnection>;
  /**
   * The number of objects connected to the object
   */
  count?: Maybe<ScalarsEnums["Int"]>;
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  featuredId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * The unique resource identifier path
   */
  id: ScalarsEnums["ID"];
  ...
  name?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the featured type and the openCanvas type
   */
  openCanvases: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<FeaturedToOpenCanvasConnectionWhereArgs>;
  }) => Maybe<FeaturedToOpenCanvasConnection>;
  /**
   * Connection between the featured type and the featured type
   */
  parent?: Maybe<FeaturedToParentFeaturedConnectionEdge>;
  /**
   * Database id of the parent node
   */
  parentDatabaseId?: Maybe<ScalarsEnums["Int"]>;
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the featured type and the Taxonomy type
   */
  taxonomy?: Maybe<FeaturedToTaxonomyConnectionEdge>;
  /**
   * The name of the taxonomy that the object is associated with
   */
  taxonomyName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the featured type and the featured type
 */
export interface FeaturedToAncestorsFeaturedConnection {
  __typename?: "FeaturedToAncestorsFeaturedConnection";
  /**
   * Edges for the FeaturedToAncestorsFeaturedConnection connection
   */
  edges?: Maybe<Array<Maybe<FeaturedToAncestorsFeaturedConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Featured>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface FeaturedToAncestorsFeaturedConnectionEdge {
  __typename?: "FeaturedToAncestorsFeaturedConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the featured type and the ContentNode type
 */
export interface FeaturedToContentNodeConnection {
  __typename?: "FeaturedToContentNodeConnection";
  /**
   * Edges for the FeaturedToContentNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<FeaturedToContentNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ContentNode>>>;
 ...
 * An edge in a connection
 */
export interface FeaturedToContentNodeConnectionEdge {
  __typename?: "FeaturedToContentNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the featured type and the featured type
 */
export interface FeaturedToFeaturedConnection {
  __typename?: "FeaturedToFeaturedConnection";
  /**
   * Edges for the FeaturedToFeaturedConnection connection
   */
  edges?: Maybe<Array<Maybe<FeaturedToFeaturedConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Featured>>>;
 ...
 * An edge in a connection
 */
export interface FeaturedToFeaturedConnectionEdge {
  __typename?: "FeaturedToFeaturedConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the featured type and the openCanvas type
 */
export interface FeaturedToOpenCanvasConnection {
  __typename?: "FeaturedToOpenCanvasConnection";
  /**
   * Edges for the FeaturedToOpenCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<FeaturedToOpenCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<OpenCanvas>>>;
 ...
 * An edge in a connection
 */
export interface FeaturedToOpenCanvasConnectionEdge {
  __typename?: "FeaturedToOpenCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the featured type and the featured type
 */
export interface FeaturedToParentFeaturedConnectionEdge {
  __typename?: "FeaturedToParentFeaturedConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Featured>;
 ...
 * Connection between the featured type and the Taxonomy type
 */
export interface FeaturedToTaxonomyConnectionEdge {
  __typename?: "FeaturedToTaxonomyConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Taxonomy>;
...
export interface MenuItemLinkable {
  __typename?: "BMCTag" | "Category" | "Featured" | "Page" | "Post" | "Tag";
  /**
   * The unique resource identifier path
   */
  databaseId: ScalarsEnums["Int"];
...
export interface OpenCanvas {
  ...
  authorId?: Maybe<ScalarsEnums["ID"]>;
  /**
   * Connection between the openCanvas type and the bMCTag type
   */
  bMCTags: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<OpenCanvasToBMCTagConnectionWhereArgs>;
  }) => Maybe<OpenCanvasToBMCTagConnection>;
  channels?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
   ...
   */
  contentTypeName: ScalarsEnums["String"];
  costStructure?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  customerRelationships?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  customerSegments?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The unique identifier stored in the database
   */
  databaseId: ScalarsEnums["Int"];
  ...
  /**
   * Connection between the openCanvas type and the featured type
   */
  featuredList: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<OpenCanvasToFeaturedConnectionWhereArgs>;
  }) => Maybe<OpenCanvasToFeaturedConnection>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the opencanvas object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
   ...
   */
  isTermNode: ScalarsEnums["Boolean"];
  keyActivities?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  keyPartners?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  keyResources?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The user that most recently edited the node
   */
  lastEditedBy?: Maybe<ContentNodeToEditLastConnectionEdge>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  openCanvasId: ScalarsEnums["Int"];
  /**
   * Connection between the openCanvas type and the openCanvas type
   */
  preview?: Maybe<OpenCanvasToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
   ...
   */
  previewRevisionId?: Maybe<ScalarsEnums["ID"]>;
  revenueStreams?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
  ...
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * Connection between the openCanvas type and the TermNode type
   */
  terms: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<OpenCanvasToTermNodeConnectionWhereArgs>;
  }) => Maybe<OpenCanvasToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
   ...
   */
  uri?: Maybe<ScalarsEnums["String"]>;
  valuePropositions?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
}

/**
 * Connection between the openCanvas type and the bMCTag type
 */
export interface OpenCanvasToBMCTagConnection {
  __typename?: "OpenCanvasToBMCTagConnection";
  /**
   * Edges for the OpenCanvasToBMCTagConnection connection
   */
  edges?: Maybe<Array<Maybe<OpenCanvasToBMCTagConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCTag>>>;
 ...
 * An edge in a connection
 */
export interface OpenCanvasToBMCTagConnectionEdge {
  __typename?: "OpenCanvasToBMCTagConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the openCanvas type and the featured type
 */
export interface OpenCanvasToFeaturedConnection {
  __typename?: "OpenCanvasToFeaturedConnection";
  /**
   * Edges for the OpenCanvasToFeaturedConnection connection
   */
  edges?: Maybe<Array<Maybe<OpenCanvasToFeaturedConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Featured>>>;
 ...
 * An edge in a connection
 */
export interface OpenCanvasToFeaturedConnectionEdge {
  __typename?: "OpenCanvasToFeaturedConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the openCanvas type and the openCanvas type
 */
export interface OpenCanvasToPreviewConnectionEdge {
  __typename?: "OpenCanvasToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<OpenCanvas>;
 ...
 * Connection between the openCanvas type and the TermNode type
 */
export interface OpenCanvasToTermNodeConnection {
  __typename?: "OpenCanvasToTermNodeConnection";
  /**
   * Edges for the OpenCanvasToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<OpenCanvasToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<TermNode>>>;
 ...
 * An edge in a connection
 */
export interface OpenCanvasToTermNodeConnectionEdge {
  __typename?: "OpenCanvasToTermNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the bMCTag type
 */
export interface RootQueryToBMCTagConnection {
  __typename?: "RootQueryToBMCTagConnection";
  /**
   * Edges for the RootQueryToBMCTagConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToBMCTagConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCTag>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToBMCTagConnectionEdge {
  __typename?: "RootQueryToBMCTagConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the bMCanvas type
 */
export interface RootQueryToBMCanvasConnection {
  __typename?: "RootQueryToBMCanvasConnection";
  /**
   * Edges for the RootQueryToBMCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToBMCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCanvas>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToBMCanvasConnectionEdge {
  __typename?: "RootQueryToBMCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the featured type
 */
export interface RootQueryToFeaturedConnection {
  __typename?: "RootQueryToFeaturedConnection";
  /**
   * Edges for the RootQueryToFeaturedConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToFeaturedConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Featured>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToFeaturedConnectionEdge {
  __typename?: "RootQueryToFeaturedConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the openCanvas type
 */
export interface RootQueryToOpenCanvasConnection {
  __typename?: "RootQueryToOpenCanvasConnection";
  /**
   * Edges for the RootQueryToOpenCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToOpenCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<OpenCanvas>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToOpenCanvasConnectionEdge {
  __typename?: "RootQueryToOpenCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface TermNode {
  __typename?: "BMCTag" | "Category" | "Featured" | "PostFormat" | "Tag";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
/**
 * The payload for the UpdateBMCTag mutation
 */
export interface UpdateBMCTagPayload {
  __typename?: "UpdateBMCTagPayload";
  /**
   * The created bmctag
   */
  bMCTag?: Maybe<BMCTag>;
...
/**
 * The payload for the updateBMCanvas mutation
 */
export interface UpdateBMCanvasPayload {
  __typename?: "UpdateBMCanvasPayload";
  /**
   * The Post object mutation type.
   */
  bMCanvas?: Maybe<BMCanvas>;
...
/**
 * The payload for the UpdateFeatured mutation
 */
...
/**
 * The payload for the updateOpenCanvas mutation
 */
export interface UpdateOpenCanvasPayload {
  __typename?: "UpdateOpenCanvasPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  ...
  /**
   * Connection between the User type and the bMCanvas type
   */
  bMCanvases: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToBMCanvasConnectionWhereArgs>;
  }) => Maybe<UserToBMCanvasConnection>;
  /**
  ...
  /**
   * Connection between the User type and the openCanvas type
   */
  openCanvases: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToOpenCanvasConnectionWhereArgs>;
  }) => Maybe<UserToOpenCanvasConnection>;
  /**
 ...
 * Connection between the User type and the bMCanvas type
 */
export interface UserToBMCanvasConnection {
  __typename?: "UserToBMCanvasConnection";
  /**
   * Edges for the UserToBMCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToBMCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BMCanvas>>>;
 ...
 * An edge in a connection
 */
export interface UserToBMCanvasConnectionEdge {
  __typename?: "UserToBMCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the User type and the openCanvas type
 */
export interface UserToOpenCanvasConnection {
  __typename?: "UserToOpenCanvasConnection";
  /**
   * Edges for the UserToOpenCanvasConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToOpenCanvasConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<OpenCanvas>>>;
 ...
 * An edge in a connection
 */
export interface UserToOpenCanvasConnectionEdge {
  __typename?: "UserToOpenCanvasConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  __typename?: "Mutation";
  createBMCTag: (args: {
    input: CreateBMCTagInput;
  }) => Maybe<CreateBMCTagPayload>;
  createBMCanvas: (args: {
    input: CreateBMCanvasInput;
  }) => Maybe<CreateBMCanvasPayload>;
  createCategory: (args: {
  ...
  }) => Maybe<CreateFeaturedPayload>;
  createMediaItem: (args: {
    input: CreateMediaItemInput;
  }) => Maybe<CreateMediaItemPayload>;
  createOpenCanvas: (args: {
    input: CreateOpenCanvasInput;
  }) => Maybe<CreateOpenCanvasPayload>;
  ...
  deleteBMCTag: (args: {
    input: DeleteBMCTagInput;
  }) => Maybe<DeleteBMCTagPayload>;
  deleteBMCanvas: (args: {
    input: DeleteBMCanvasInput;
  }) => Maybe<DeleteBMCanvasPayload>;
  deleteCategory: (args: {
  ...
  }) => Maybe<DeleteFeaturedPayload>;
  deleteMediaItem: (args: {
    input: DeleteMediaItemInput;
  }) => Maybe<DeleteMediaItemPayload>;
  deleteOpenCanvas: (args: {
    input: DeleteOpenCanvasInput;
  }) => Maybe<DeleteOpenCanvasPayload>;
  ...
  updateBMCTag: (args: {
    input: UpdateBMCTagInput;
  }) => Maybe<UpdateBMCTagPayload>;
  updateBMCanvas: (args: {
    input: UpdateBMCanvasInput;
  }) => Maybe<UpdateBMCanvasPayload>;
  updateCategory: (args: {
  ...
  }) => Maybe<UpdateFeaturedPayload>;
  updateMediaItem: (args: {
    input: UpdateMediaItemInput;
  }) => Maybe<UpdateMediaItemPayload>;
  updateOpenCanvas: (args: {
    input: UpdateOpenCanvasInput;
  }) => Maybe<UpdateOpenCanvasPayload>;
...
export interface Query {
  ...
  bMCTags: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToBMCTagConnectionWhereArgs>;
  }) => Maybe<RootQueryToBMCTagConnection>;
  bMCanvas: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<BMCanvasIdType>;
  }) => Maybe<BMCanvas>;
  bMCanvasBy: (args?: {
    bMCanvasId?: Maybe<Scalars["Int"]>;
    id?: Maybe<Scalars["ID"]>;
  ...
  bMCanvases: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToBMCanvasConnectionWhereArgs>;
  }) => Maybe<RootQueryToBMCanvasConnection>;
  categories: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
  ...
  featuredList: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToFeaturedConnectionWhereArgs>;
  }) => Maybe<RootQueryToFeaturedConnection>;
  generalSettings?: Maybe<GeneralSettings>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
  ...
  openCanvas: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<OpenCanvasIdType>;
  }) => Maybe<OpenCanvas>;
  openCanvasBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    openCanvasId?: Maybe<Scalars["Int"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<OpenCanvas>;
  openCanvases: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToOpenCanvasConnectionWhereArgs>;
  }) => Maybe<RootQueryToOpenCanvasConnection>;
  page: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
...
export interface SchemaObjectTypes {
  ...
  Avatar: Avatar;
  BMCTag: BMCTag;
  BMCTagToBMCanvasConnection: BMCTagToBMCanvasConnection;
  BMCTagToBMCanvasConnectionEdge: BMCTagToBMCanvasConnectionEdge;
  BMCTagToContentNodeConnection: BMCTagToContentNodeConnection;
  BMCTagToContentNodeConnectionEdge: BMCTagToContentNodeConnectionEdge;
  BMCTagToOpenCanvasConnection: BMCTagToOpenCanvasConnection;
  BMCTagToOpenCanvasConnectionEdge: BMCTagToOpenCanvasConnectionEdge;
  BMCTagToTaxonomyConnectionEdge: BMCTagToTaxonomyConnectionEdge;
  BMCanvas: BMCanvas;
  BMCanvasToBMCTagConnection: BMCanvasToBMCTagConnection;
  BMCanvasToBMCTagConnectionEdge: BMCanvasToBMCTagConnectionEdge;
  BMCanvasToPreviewConnectionEdge: BMCanvasToPreviewConnectionEdge;
  BMCanvasToTermNodeConnection: BMCanvasToTermNodeConnection;
  BMCanvasToTermNodeConnectionEdge: BMCanvasToTermNodeConnectionEdge;
  Category: Category;
  ...
  CreateBMCTagPayload: CreateBMCTagPayload;
  CreateBMCanvasPayload: CreateBMCanvasPayload;
  CreateCategoryPayload: CreateCategoryPayload;
  CreateCommentPayload: CreateCommentPayload;
  CreateFeaturedPayload: CreateFeaturedPayload;
  CreateMediaItemPayload: CreateMediaItemPayload;
  CreateOpenCanvasPayload: CreateOpenCanvasPayload;
  ...
  DeleteBMCTagPayload: DeleteBMCTagPayload;
  DeleteBMCanvasPayload: DeleteBMCanvasPayload;
  DeleteCategoryPayload: DeleteCategoryPayload;
  DeleteCommentPayload: DeleteCommentPayload;
  DeleteFeaturedPayload: DeleteFeaturedPayload;
  DeleteMediaItemPayload: DeleteMediaItemPayload;
  DeleteOpenCanvasPayload: DeleteOpenCanvasPayload;
  ...
  Featured: Featured;
  FeaturedToAncestorsFeaturedConnection: FeaturedToAncestorsFeaturedConnection;
  FeaturedToAncestorsFeaturedConnectionEdge: FeaturedToAncestorsFeaturedConnectionEdge;
  FeaturedToContentNodeConnection: FeaturedToContentNodeConnection;
  FeaturedToContentNodeConnectionEdge: FeaturedToContentNodeConnectionEdge;
  FeaturedToFeaturedConnection: FeaturedToFeaturedConnection;
  FeaturedToFeaturedConnectionEdge: FeaturedToFeaturedConnectionEdge;
  FeaturedToOpenCanvasConnection: FeaturedToOpenCanvasConnection;
  FeaturedToOpenCanvasConnectionEdge: FeaturedToOpenCanvasConnectionEdge;
  FeaturedToParentFeaturedConnectionEdge: FeaturedToParentFeaturedConnectionEdge;
  FeaturedToTaxonomyConnectionEdge: FeaturedToTaxonomyConnectionEdge;
  ...
  OpenCanvas: OpenCanvas;
  OpenCanvasToBMCTagConnection: OpenCanvasToBMCTagConnection;
  OpenCanvasToBMCTagConnectionEdge: OpenCanvasToBMCTagConnectionEdge;
  OpenCanvasToFeaturedConnection: OpenCanvasToFeaturedConnection;
  OpenCanvasToFeaturedConnectionEdge: OpenCanvasToFeaturedConnectionEdge;
  OpenCanvasToPreviewConnectionEdge: OpenCanvasToPreviewConnectionEdge;
  OpenCanvasToTermNodeConnection: OpenCanvasToTermNodeConnection;
  OpenCanvasToTermNodeConnectionEdge: OpenCanvasToTermNodeConnectionEdge;
  Page: Page;
  ...
  RootQueryToBMCTagConnection: RootQueryToBMCTagConnection;
  RootQueryToBMCTagConnectionEdge: RootQueryToBMCTagConnectionEdge;
  RootQueryToBMCanvasConnection: RootQueryToBMCanvasConnection;
  RootQueryToBMCanvasConnectionEdge: RootQueryToBMCanvasConnectionEdge;
  ...
  RootQueryToFeaturedConnection: RootQueryToFeaturedConnection;
  RootQueryToFeaturedConnectionEdge: RootQueryToFeaturedConnectionEdge;
  ...
  RootQueryToOpenCanvasConnection: RootQueryToOpenCanvasConnection;
  RootQueryToOpenCanvasConnectionEdge: RootQueryToOpenCanvasConnectionEdge;
  ...
  Theme: Theme;
  UpdateBMCTagPayload: UpdateBMCTagPayload;
  UpdateBMCanvasPayload: UpdateBMCanvasPayload;
  UpdateCategoryPayload: UpdateCategoryPayload;
  UpdateCommentPayload: UpdateCommentPayload;
  UpdateFeaturedPayload: UpdateFeaturedPayload;
  UpdateMediaItemPayload: UpdateMediaItemPayload;
  UpdateOpenCanvasPayload: UpdateOpenCanvasPayload;
  ...
  User: User;
  UserRole: UserRole;
  UserToBMCanvasConnection: UserToBMCanvasConnection;
  UserToBMCanvasConnectionEdge: UserToBMCanvasConnectionEdge;
  ...
  UserToOpenCanvasConnection: UserToOpenCanvasConnection;
  UserToOpenCanvasConnectionEdge: UserToOpenCanvasConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  BMCTagIdType: BMCTagIdType | undefined;
  BMCanvasIdType: BMCanvasIdType | undefined;
  ...
  OpenCanvasIdType: OpenCanvasIdType | undefined;
